...
import tank_game.menus.EndGamePanel;
import tank_game.menus.StartMenuPanel;
...
public class Launcher {
    ...
    private void initUIComponents(){
        ...
        this.gamePanel = new GameDriver(this); // create a new game panel
    ...
    public void setFrame(String type){
        ...
        switch(type){
            case "start":
                ...
                this.jf.setSize(GameSettings.START_MENU_SCREEN_WIDTH, GameSettings.START_MENU_SCREEN_HEIGHT);
                this.jf.setLocationRelativeTo(null);
                break;
            case "game":
                // set the size of the jFrame to the expected size for the game panel
                this.jf.setSize(GameSettings.GAME_SCREEN_WIDTH, GameSettings.GAME_SCREEN_HEIGHT);
                this.jf.setLocationRelativeTo(null);
            ...
            case "end":
                ...
                this.jf.setSize(GameSettings.END_MENU_SCREEN_WIDTH, GameSettings.END_MENU_SCREEN_HEIGHT);
                this.jf.setLocationRelativeTo(null);
                break;
        }
